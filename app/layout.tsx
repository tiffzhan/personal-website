...
export const metadata: Metadata = {
	...
	authors: [{ name: 'Tiffany Zhan' }],
	creator: 'Tiffany Zhan',
	openGraph: {
		title: 'Tiffany Zhan - Developer Portfolio',
		...
		siteName: 'Tiffany Zhan - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Tiffany Zhan - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
